        ...
        <div id="sales_overview" class="small_button">
            <a href="<?= site_url($controller_name . '/manage') ?>"><span><?php echo $this->lang->line('sales_takings'); ?><span></a>
                    ...
                    <div id="show_suspended_sales_button">
                        <?php
                        echo anchor("sales/suspended/width:425",
                    ...
                    <div id="new_item_button_register" >
                        <?php
                        echo anchor("items/view/-1/width:450",
                    ...
                    <div id="overall_sale">
                        ...
                        if (isset($customer)) {
                            ...
                            <div style="margin-top: 5px; text-align: center;">
                                ...
                                <?php
                                echo anchor("customers/view/-1/width:400",
                        ...
                        <div id='sale_details'>
                            <div class="float_left" style="width: 55%;">Qty:</div><div class="float_left" style="width: 45%; font-weight: bold;"><?php echo array_sum(array_column($cart, 'quantity')); ?></div>
...
// Only show this part if there are Items already in the sale.
                        if (count($cart) > 0) {
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 45%; text-align: right;"><div class="float_left"
                                                                                    style="text-align: right; font-weight: bold;"><?php echo to_currency($totaldiscount); ?></div></td>
                                </tr>
                    ...
                    <script type="text/javascript" language="javascript">
                        $(document).ready(function ()
                        {
                            ...
                            {
                                if ($(this).val().match("<?php
                        echo $this->lang->line('sales_start_typing_item_name') . '|' .
