...
?>
	...
	<?php echo form_label('Select Supplier', 'reports_suppliers_label', array('class'=>'required')); ?>
	<div id='report_item_count'>
            <select name="supplierid" id="supplierid">
                <option value="all">All Supplier Items</option>
                <option value="0">Unknown/Not Listed</option>
            <?php 
...
$(document).ready(function()
{
	$("#generate_report").click(function()
	{
		...
		window.location = window.location+'/' + export_excel + '/' + $("#location_id").val() + '/' + $("#item_count").val()+ '/' + $("#supplierid").val();
	});	
});
</script>