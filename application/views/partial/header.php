        ...
        <div id="menubar">
            <div id="menubar_container">
                <div id="menubar_company_info">
                    <span id="company_title"><a href="<?php echo base_url(); ?>">
                            <span style='font-size:18pt;'><?php echo $this->config->item('company'); ?></span></a></span>
                </div>
                    ...
                    foreach ($allowed_modules->result() as $module) {
                        ...
                        <div class="menu_item">
                            <a href="<?php echo site_url("$module->module_id"); ?>">
                                ...
                                <a href="<?php echo site_url("$module->module_id"); ?>" accesskey="<?php echo $module->accesskey; ?>"><?php echo $this->lang->line("module_" . $module->module_id) ?></a>
                        </div>
                        <?php
                    }
                    ?>

                    <div class="menu_item" style="width:150px;font-size: 12px;">
                        <img src="<?php echo base_url() . 'images/menubar/opt.png'; ?>" border="0" alt="Menubar Image"> <br>
                                <?php echo " $user_info->first_name $user_info->last_name! | "; ?>
                                <?php echo anchor("home/logout", $this->lang->line("common_logout")); ?>
                                </div>

                                <div class="menu_item" style="width:120px;font-size: 12px;">
                                    Powered By<br/> <img src="<?php echo base_url() . 'images/kalni.png'; ?>" border="0" alt="Menubar Image">
                                </div>
